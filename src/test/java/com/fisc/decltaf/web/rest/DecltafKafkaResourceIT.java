...
import com.fisc.decltaf.DecltafApp;
...
@SpringBootTest(classes = DecltafApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecltafKafkaResourceIT {
    ...
    @Autowired
    private DecltafKafkaProducer producer;

    @Autowired
    private DecltafKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecltafKafkaResource kafkaResource = new DecltafKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decltaf-kafka/publish?message=test"))
